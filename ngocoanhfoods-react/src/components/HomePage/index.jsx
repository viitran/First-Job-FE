    ...
    <div className="homePage-container">
      ...
      <div className="q-home d-flex container-fl" style={{ flexWrap: "wrap" }}>
        <div className="col-lg-7 col-12">
          ...
          >
            ...
            <span style={{ color: "rgb(51 167 93)" }}> LỰA CHỌN</span> NGỌC OANH
            FOODS
          </h2>
        </div>
        <div className="col-lg-5 col-12">
          <p>
            Thương hiệu Ngọc Oanh Foods đã và đang cung cấp ra thị trường các
            sản phẩm dinh dưỡng 100% healthy , hỗ trợ cải thiện sức khỏe, tái
            tạo năng lượng cho mọi khách hàng.
          </p>
        </div>
      </div>
              ...
              {categories.map((cate) => (
                <SwiperSlide key={cate.id}>
                  ...
                  >
                    <div className="d-flex justify-content-center">
                      <img
                        src={`http://localhost:1337${cate?.attributes.image.data.attributes.url}`}
                        alt="..."
                      />
                    </div>
                    <div>
      ...
      <div className="q-home d-flex container-fl" style={{ flexWrap: "wrap" }}>
        <div className="col-lg-7 col-12">
          <h2
            ...
            style={{ fontWeight: "bold", lineHeight: "normal" }}
          >
            <span style={{ color: "rgb(51 167 93)" }}>QUY TRÌNH </span>SẢN XUẤT
            <br />
            TẠI NGỌC OANH FOODS
          </h2>
        </div>
        <div className="col-lg-5 col-12">
          <p>
            Ngọc Oanh Foods tuân thủ nghiêm ngặt các tiêu chuẩn chất lượng cao
            nhất trong toàn bộ quá trình sản xuất
          </p>
        </div>
      </div>
              ...
              <div className="col-9">
                ...
                <div>
                  ...
                  <p className="content-crs3">
                    Nguyên liệu đầu vào tại Ngọc Oanh Foods được nhập khẩu trực
                    tiếp từ các quốc gia như Úc, Mỹ, Chile, các nước Nam Phi,..
                    và các cơ sở chế biến đạt tiêu chuẩn VietGAP.
                  </p>
                  <Link
                    to={"/a"}
                    className="mt-3 mb-2"
            ...
            <div className="card-home-crs3">
              <div className="col-9">
                ...
                <div>
                  ...
                  <p className="content-crs3">
                    Mỗi sản phẩm tại Ngọc Oanh Foods sẽ có quy trình chế biến
                    khác nhau. Chúng tôi luôn tuân thủ nghiêm ngặt các tiêu
                    chuẩn chất lượng cao nhất về an toàn vstp.
                  </p>
                  <Link
                    to={"/a"}
                    className="mt-3 mb-2"
            ...
            <div className="card-home-crs3">
              <div className="col-9">
                ...
                <div>
                  ...
                  <p className="content-crs3">
                    Sau quá trình sản xuất, các sản phẩm dinh dưỡng tại Ngọc
                    Oanh Foods sẽ được kiểm tra thành phẩm rồi đóng gói, hút
                    chân không theo quy trình khép kín, hiện đại.
                  </p>
                  <Link
                    to={"/a"}
                    className="mt-3 mb-2"
            ...
            <div className="card-home-crs3">
              <div className="col-9">
                ...
                <div>
                  ...
                  <p className="content-crs3">
                    Hầu hết các sản phẩm mang thương hiệu Ngọc Oanh Foods sẽ có
                    thời gian bảo quản là 6 tháng. Do không dùng chất bảo quản
                    tổng hợp trong quá trình sản xuất.
                  </p>
                  <Link
                    to={"/a"}
                    className="mt-3 mb-2"
      ...
      <div>
        <div>
          ...
          >
            CÂU CHUYỆN{" "}
            <span style={{ color: "rgb(51 167 93)" }}>NGỌC OANH FOODS</span>
          </h2>
        </div>
      </div>
        ...
        <div className="container-fl d-flex" style={{ flexWrap: "wrap" }}>
          <div className="col-lg-4 col-12" style={{ paddingTop: "30px" }}>
            <h2
              ...
              style={{ fontWeight: "bold", lineHeight: "normal" }}
            >
              <span style={{ color: "rgb(51 167 93)" }}>CẢM ƠN </span>
              SỰ TIN TƯỞNG CỦA KHÁCH HÀNG
            </h2>
            <p className="mt-4">
              Ngọc Oanh Foods chân thành cảm ơn sự ủng hộ của tất cả các khách
              hàng đã yêu mến và tin tưởng Ngọc Oanh Foods .....
            </p>
          </div>
          <div className="col-lg-4 col-12" style={{ paddingTop: "30px" }}>
            <div className="feedback-card mx-4 p-4">
              ...
              <div className="mt-3">
                <p>Anh A</p>
                <p>
                  Là một người khá kỹ tính, tôi luôn luôn lựa chọn những thực
                  phẩm sạch và tốt cho sức khỏe nhất, V và đây là nơi tôi đặt
                  trọng niềm tin.
                </p>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-12" style={{ paddingTop: "30px" }}>
            <div className="feedback-card mx-4 p-4">
              ...
              <div className="mt-3">
                <p>Anh B</p>
                <p>
                  Là một huấn luận viên tôi luôn lựa chọn kĩ càng những thực
                  phẩm nạp vào cơ thể, và BakerBaking là sự lựa chọn của tôi.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="container-fl blog">
        <div>
          ...
          >
            ...
            <span style={{ color: "rgb(51 167 93)" }}>
        ...
        <div className="d-flex pt-3" style={{ flexWrap: "wrap" }}>
          ...
          >
            ...
            <div className="col-9">
              <Link to={"/"} className="title-blog">
                Ngũ cốc dành cho bà bầu loại nào tốt? Nên mua ở đâu?
              </Link>
              <p>
                Ngũ cốc dành cho bà bầu loại nào tốt và nên mua ở đâu luôn được
                phụ nữ mang thai quan tâm. Để chọn được loại ngũ cốc chất lượng
                nhất, người dùng có thể mua ở các siêu thị, cửa...
              </p>
            </div>
          </div>
          <div
          ...
          >
            ...
            <div className="col-9">
              <Link to={"/"} className="title-blog">
                Nên mua bánh gạo lứt ở đâu để đảm bảo chất lượng tốt nhất?
              </Link>
              <p>
                Hiện nay, có rất nhiều người tìm mua bánh gạo lứt như một món ăn
                vặt Healthy giàu dinh dưỡng. Với hương vị hấp dẫn dễ ăn và hàm
                lượng dinh dưỡng cao, nếu chọn được đúng nơi mua uy tín,...
              </p>
            </div>
          </div>
          <div
          ...
          >
            ...
            <div className="col-9">
              <Link to={"/"} className="title-blog">
                Ngũ cốc mua ở đâu? 3 điểm mua nên trải nghiệm
              </Link>
              <p>
                Ngoài chất lượng sản phẩm, ngũ cốc Granola mua ở đâu cũng là
                thắc mắc được nhiều người đặt ra khi chọn mua Granola. Người
                dùng có thể mua Granola ở các siêu thị, cửa hàng tiện lợi hoặc
                các...
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="col-9">
              <Link to={"/"} className="title-blog">
                Hạt hạnh nhân giá bao nhiêu? Lợi ích vàng cho sức khỏe
              </Link>
              <p>
                Từ lâu, hạt hạnh nhân được giới giảm cân và làm đẹp ưu ái với
                nguồn dưỡng chất cao đồng thời hỗ trợ cải thiện cân nặng và làn
                da. Không chỉ thế hạnh nhân còn được giới dinh dưỡng...
              </p>
            </div>
          </div>
        </div>
